...
const RawMaterialsPage = () => {
  ...
  return (
    <CatalogListView
      ...
      subtitle="Insumos disponibles para recetas, compras y movimientos de stock."
      loading={loading}
      error={error}
      items={items}
      nameField="description"
      createHref="/catalogo/nueva-materia-prima"
      createLabel="Nueva materia prima"
      searchPlaceholder="Buscar materia prima por nombre, SKU o codigo"
      typeLabel="Materia prima"
    />
  );
};
